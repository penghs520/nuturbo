 ...
 */
@Getter
public class UpdateCardNameRequest extends BaseRequest {

    private final String cardName;

    @JsonCreator
    protected UpdateCardNameRequest(@JsonProperty("memberId") MemberId memberId, @JsonProperty("cardName") String cardName) {
        super(memberId);
